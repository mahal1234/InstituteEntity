...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <!--All below coding has used the entity framework and CRUD based operation is used and all data is autogenrated -->
    <!-- headings for understanding -->
     <h1 align="center"><u> Salary Details </u></h1>
    ...
    <marquee><h2 align="center">Salary Record  </h2></marquee>
      <div class="container">
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InstituteDBConnectionString6 %>" DeleteCommand="DELETE FROM [Salary] WHERE [ID] = @ID" InsertCommand="INSERT INTO [Salary] ([Name], [Contact], [Salary], [PaymentDate]) VALUES (@Name, @Contact, @Salary, @PaymentDate)" SelectCommand="SELECT * FROM [Salary] ORDER BY [ID] DESC" UpdateCommand="UPDATE [Salary] SET [Name] = @Name, [Contact] = @Contact, [Salary] = @Salary, [PaymentDate] = @PaymentDate WHERE [ID] = @ID">
                <DeleteParameters>
